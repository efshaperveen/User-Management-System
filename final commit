...
```bash
git clone https://github.com/efshaperveen/User-Management-System.git
...
📎 Video Link: [https://drive.google.com/file/d/1nF0cuA2724mv4vJ66hrmaXMgfL9k0XB_/view?usp=drivesdk]
